                        ...
                        {p.products.map((pt, i) => (
                          <div
                            className={`w-full flex flex-wrap  ${
                              i !== p.products.length - 1 ? "border-b pb-3" : ""
                            } `}
                          >
